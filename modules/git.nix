...
{
  # Git Configuration
  # Manual setup required - see docs/DEVELOPER_IDENTITY.md for details
  ...
  home.activation.setupGitIdentity =
    lib.hm.dag.entryAfter [ "writeBoundary" ] ''
      ...
      echo ""
      echo "📚 See docs/DEVELOPER_IDENTITY.md for full configuration details"
      echo ""
    '';
}
